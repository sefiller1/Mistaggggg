...
async def start(event):
  await event.reply("Merhaba👨‍💻! [{usr.first_name}] Ben @Userr_Tagbot Grubunuzdaki Kullanıcıları Etiketlemek İçin Oluşturulmuş Sizin Emrinizde Çalışmak için Hazırlanmış Botum.Aşağıdakı Komutlar Butonuna Basarak Yapman Gerekenleri Görebilirsin Keyifli Günler 🥰.",
                    buttons=(
